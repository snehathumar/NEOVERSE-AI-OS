...
<style>
    ...
    .badge-Pending { background: #d69e2e; color: black; }
    .badge-Approved { background: #38a169; color: white; }
    .badge-Override { background: #e53e3e; color: white; }
    .badge-Escalated { background: #805ad5; color: white; }
